...
def menu_overview() -> Response:
    components = build_components([menu_page_navigation_component, menu_overview_component])
...
def add_menu_item() -> Response:
    components = build_components([menu_page_navigation_component, add_menu_item_component])
...
def edit_menu_item(item_id: int) -> Response:
    components = build_components([menu_page_navigation_component, lambda: edit_menu_item_component(item_id)])
...
def delivery_radius() -> Response:
    components = build_components([set_delivery_radius_component, get_delivery_radius_component])
